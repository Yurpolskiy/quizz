...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: cn(`bg-btn-primary hover:bg-btn-primary-hover text-btn-primary-text`),
    secondary: 'bg-btn-secondary hover:bg-btn-secondary-hover text-btn-secondary-text border-btn-secondary',
